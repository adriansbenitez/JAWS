...
switch ($_POST["nivel"]){
    ...
    case 3:
        $masFallos .= " u.id_unidad = ?";
        array_push($parametros, $_POST["entidad"]);
        break;
}

$masFallos .= " and re.correcta != 1 group by id_pregunta, codigo, enunciado order by total desc limit 20";

$bd = new BD();

$bd->setConsulta($masFallos);
